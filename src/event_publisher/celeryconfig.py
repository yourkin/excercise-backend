...
imports = ("event_publisher.tasks.order_tasks",)
...
beat_schedule = {
    ...
    "run-every-minute": {
        "task": "event_publisher.tasks.order_tasks.publish_events_to_rabbitmq",  # The name of the task to execute
...
beat_schedule_filename = "./event_publisher/celerybeat-schedule"  # File path to store the last run times of the tasks.
